...
public class ListItems2 implements Initializable {
    ...
    private static final String SQL_QUERY = "SELECT rowid, codigo as Codigo, descricao as Descricao, linha as Linha, qtde as Qtde, peso from perfis;";
...
//            Logger.getLogger(ListItems2.class.getName()).log(Level.SEVERE, null, e);
//            e.printStackTrace();
//        }
